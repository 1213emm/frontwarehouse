    ...
    <div class="wrap">
      ...
      <el-form :model="form" ref="form" class="form">
        <el-form-item prop="username">
          <el-input placeholder="旧密码" v-model="form.password" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item prop="username">
          <el-input placeholder="新密码" v-model="form.password1" autocomplete="off"></el-input>
        </el-form-item>
        ...
        <el-form-item class="btn_login">
          <el-button type="primary" @click="login">确&nbsp;&nbsp;认</el-button>
        </el-form-item>
      </el-form>
    </div>
  </div>
